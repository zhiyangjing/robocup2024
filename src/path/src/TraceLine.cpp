...
TraceLine::TraceLine(int remain_time, ros::NodeHandle &nh) : Ability(remain_time, nh) {
    ...
    x << -0.5, -0.776, -0.4, -0.46, -0.584, -0.70, -0.51, -0.48, -1.397, 0, 0, -1.25, 0, -0.6, 0, 0;
    y << 0.620, 0.43, 0.84, 0.753, 0.575, 0.496, 0.51, 0.578, 0, 1.4, 1.2, 0, 0.67, 0.5, 0.52, 0.63;
    c << 300, 460, 206, 247, 350, 400, 471, 217, 450, 246, 184, 505, 215, 310, 310, 240;
    z << 0, 0, 0, 0, 0, 0, 150, -150, 120, -120, -200, 200, -200, 0, 0, -150;
