...
TraceLine::TraceLine(int remain_time, ros::NodeHandle &nh) : Ability(remain_time, nh) {
    ...
    x << -0.5, -0.776, -0.4, -0.46, -0.584, -0.70, -0.51, -0.48, -1.397, 0, 0, -1.25, 0, -0.6, 0, 0, -0.6, -0.41, -0.58,
        -0.7, -0.4;
    y << 0.620, 0.43, 0.84, 0.753, 0.575, 0.496, 0.51, 0.578, 0, 1.4, 1.2, 0, 0.67, 0.5, 0.52, 0.63, 0, 0, 0, 0, 0;
    c << 300, 460, 206, 247, 350, 400, 471, 217, 450, 246, 184, 505, 215, 310, 310, 240, 497, 343, 310, 339, 405;
    z << 0, 0, 0, 0, 0, 0, 150, -170, 120, -120, -230, 200, -230, 0, 0, -170, 200, 150, 0, 0, 230;
