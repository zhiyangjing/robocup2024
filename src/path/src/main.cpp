...
public:
    PathController(ros::NodeHandle nh) : nh_(nh) {
        ...
        reverse_park_params.ref_points.row(2) << 124, 136, 113, 363, 369, -136, -128, 37, 200, 253, 30, 115;
        reverse_park_params.ref_value << 0, 0, 0, -200, -200, 200, 200, 100, -100, -150, 150, -200;
