...
public:
    TraceLine(int remain_time, ros::NodeHandle &nh) : Ability(remain_time, nh) {
        ...
        x << -6.61, 1.271, 0.424, 0.806, 0.527, 0.43, 0.71, 0.69, 0.5, 0.56;
        y << 0.64, -0.45, -1.301, -0.475, -0.919, 0, 0, 0, 0, 0;
        c << 299, 150, 486, 112, 481, 250, 190, 340, 280, 232;
        z << 0, -100, 100, -200, 200, -200, 100, 50, -200, -100;
